# 💻 Distributed System -- Nhanh `client-1`

## Vai tro: JavaFX Client 1
...
```
  +-------------+     +------------------+     +-------------------+
  |  CLIENT 1   |---->|  LOAD BALANCER   |---->|  Worker Server 1  |
...
| `client-1` | **JavaFX Client 1** <-- BAN O DAY | common-lib, javafx-client | `RUN.bat` |
